...
$\displaystyle \mathrm{AUC}(S, F) = 1/2 +
\frac{\pi\,p\,(1-\pi)\,(d_1 - d_0)}{2\,\mu\,(1-\mu)}$, while
$\mathrm{AUC}(S, C) = 1/2$ exactly.
\end{proposition}
...
%
\[
  \mathrm{AUC}(F_{t-1}, F_t) \;=\; 1/2 + p\,(d_1 - d_0)/2
  \;\leq\; (1+p)/2,
\]
%
...
%
\[
  d(S) \;=\; d_{\min} + \frac{d_{\max} - d_{\min}}{1 + \exp\{-\alpha (S - c)\}} ,
  \qquad d_{\min} = \nContDmin{},\; d_{\max} = \nContDmax{},\; c = \nContC{} .
\]
%
...
\paragraph{Sample size.} Fig.~\ref{fig:finite} gives the sampling
