...
follow-up, and one number about its size.
...
on the underlying condition rate, not generally an estimate of it.
...
governs precision. What can be said about detection is a question about audit
