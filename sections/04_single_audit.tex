...
may still occur. The selection is risk based. Larger programs, measured by federal dollars
expended, fall into a regulatory category called \emph{Type~A}; smaller ones
are Type~B. A Type~A program that meets a list of low-risk criteria may be
...
coverage more likely, and its sample construction holds coverage fixed.} The
...
major in both years holds the major-program-selection channel fixed. It does
not hold audit intensity or condition-specific observation fixed: the
