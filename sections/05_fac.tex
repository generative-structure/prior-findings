...
period, \nMixedShare{} percent of all prior-finding outcomes, has to be
assigned to one side first. Assign none of them to recurrence and the share is
\nZetaLo{} percent. Assign all of them and it is \nZetaHi{} percent. The
summary moves \nZetaSwing{} percentage points, and nothing in the underlying
observations changes (Figure~\ref{fig:zeta}). A two-category recurrence share
