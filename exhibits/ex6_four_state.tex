\begin{table}[tbp]
\centering
\caption{\textbf{What follows a prior-year finding.} Sample A: 206,926 program-years
...
ratio column is left blank for the three repeat-involving rows: with no prior
finding a recorded repeat is close to impossible, so the baseline is
structurally near zero and the ratio is arbitrarily large rather than
informative. The risk differences are the usable quantities there.}
\label{tab:fourstate}
\footnotesize
