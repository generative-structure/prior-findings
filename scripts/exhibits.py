...
Figure B.1 and exhibits/numbers_rev.tex from the verified simulation tables
...
fitted_model_validation.csv).  Run scripts/format_tables.py afterwards
(`make exhibits` does both).
...
Fig.~\ref{fig:finite} there. Solid series are measured against the recorded
